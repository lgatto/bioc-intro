...
```{r, results="markup", echo=FALSE, purl=FALSE, fig.align="center", fig.alt = "Spreadsheet setup"}
...
```{r, results="markup", echo=FALSE, purl=FALSE, out.width="70%", fig.align="center", fig.alt = "More than one info per cell"}
...
```{r, results="markup", echo=FALSE, purl=FALSE, out.width="70%", fig.align="center", fig.alt = "Single info per cell"}
...
```{r, results="markup", echo=FALSE, purl=FALSE, fig.align="center", fig.alt = "Multiple tables par sheet"}
...
```{r, results="markup", echo=FALSE, purl=FALSE, fig.align="center", fig.alt = "Table describing how to encode missing data"}
...
```{r, results="markup", echo=FALSE, purl=FALSE, fig.align="center", fig.alt = "Using colours to convey information"}
...
```{r, results="markup", echo=FALSE, purl=FALSE, fig.align="center", fig.alt = "Using a proper variable to encode information previously conveyed with colour"}
...
```{r, results="markup", fig.cap="Saving an Excel file to CSV.", echo=FALSE, purl=FALSE, fig.align="center", fig.alt = "Export to csv"}
...
```{r, results="markup", fig.cap="The risks of having commas inside comma-separated data.", echo=FALSE, purl=FALSE, fig.align="center", fig.alt = "The risks of having commas inside comma-separated data"}
...
```{r analysis, results="asis", fig.margin=TRUE, fig.cap="A typical data analysis workflow.", fig.width=7, fig.height=4, echo=FALSE, purl=FALSE, fig.alt = "A typical data analysis workflow"}
